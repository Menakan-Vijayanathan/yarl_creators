...
const Brand = () => {
  return (
    <div className=" p-16 min-h-screen bg-black text-white ">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {brands.map((brand, index) => (
            <div
              key={index}
              className="relative group overflow-hidden rounded-xl bg-black aspect-[2/1] flex items-center justify-center p-6 transition-all duration-500 hover:bg-[#16181f] border border-gray-900 "
            >
              <div className="relative z-10 w-full h-28 flex items-center justify-center">
                <div
                  className="w-full h-24 bg-contain bg-center bg-no-repeat filter brightness-0 invert"
