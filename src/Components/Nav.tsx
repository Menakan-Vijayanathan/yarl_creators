    ...
    <nav className="fixed top-0 left-0 right-0 bg-[#0F1115] rounded-b-2xl mt-3 px-6 py-5 md:px-8 max-w-screen-xl mx-auto z-10">
      <div className="flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-10 mx-auto">
          <a href="#" className="text-gray-500 hover:text-[#FFE600] transition-colors text-base">About</a>
          <a href="#" className="text-gray-500 hover:text-[#FFE600] transition-colors text-base">Solutions</a>
          <a href="#" className="text-gray-500 hover:text-[#FFE600] transition-colors text-base">Pricing</a>
        </div>
